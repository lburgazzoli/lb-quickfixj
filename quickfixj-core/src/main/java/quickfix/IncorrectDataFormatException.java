...
public class IncorrectDataFormatException extends Exception {
     ...
     */
    public IncorrectDataFormatException(final int field, final String data) {
     ...
     * @param field the tag number with the incorrect data
     */
    public IncorrectDataFormatException(final int field) {
        this(field, null);
    }
     ...
     * @param message
     */
    public IncorrectDataFormatException(final String message) {
        this(0, null, message);
    }

    private IncorrectDataFormatException(final int field, final String data, final String message) {
        super(message);
        this.field = field;
        this.data = data;
    }
