 ...
 */
public class RejectLogonException extends Exception {

    private final boolean logoutBeforeDisconnect;
    private final int     sessionStatus;

    public RejectLogonException() {
        this(null, true, -1);
    }
     ...
     */
    public RejectLogonException(String msg) {
        this(msg, true, -1);
    }
     ...
     * @param msg text to print to session event log
     */
    public RejectLogonException(String msg, int sessionStatus) {
     ...
     */
    public RejectLogonException(String msg, boolean logoutBeforeDisconnect, int sessionStatus) {
        super(msg);
